...
export function analyzeDiffusionArtifact(pixels: Uint8ClampedArray, width: number, height: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55
            ? "Mid-frequency smoothing with sharp edges detected â€” pattern consistent with diffusion models"
            : "No diffusion model artifacts detected â€” frequency structure appears natural",
