/**
 * Blink Rate Analysis
 * Eye region blink pattern naturalness
 */
...
export function analyzeBlinkRateAnalysis(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Eye region blink pattern naturalness — potential AI-generated video artifact" : "Natural eye region blink pattern naturalness — consistent with authentic video",
