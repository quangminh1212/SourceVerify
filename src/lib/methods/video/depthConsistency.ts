...
export function analyzeDepthConsistency(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Depth map consistency analysis — potential AI-generated video artifact" : "Natural depth map consistency analysis — consistent with authentic video",
