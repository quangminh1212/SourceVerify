...
export function analyzeVideoGrainAnalysis(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Film grain pattern analysis — potential AI-generated video artifact" : "Natural film grain pattern analysis — consistent with authentic video",
