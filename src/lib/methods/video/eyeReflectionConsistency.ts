 ...
 * Catchlight and eye reflection pattern
 */
...
export function analyzeEyeReflectionConsistency(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Catchlight and eye reflection pattern — potential AI-generated video artifact" : "Natural catchlight and eye reflection pattern — consistent with authentic video",
