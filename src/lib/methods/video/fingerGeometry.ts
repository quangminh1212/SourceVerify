/**
 * Finger Geometry
 * Finger count and geometry analysis
 */
...
export function analyzeFingerGeometry(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Finger count and geometry analysis — potential AI-generated video artifact" : "Natural finger count and geometry analysis — consistent with authentic video",
