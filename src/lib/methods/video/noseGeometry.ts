...
export function analyzeNoseGeometry(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Nose 3D consistency analysis — potential AI-generated video artifact" : "Natural nose 3d consistency analysis — consistent with authentic video",
