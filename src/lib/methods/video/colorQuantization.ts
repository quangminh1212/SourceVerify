/**
 * Color Quantization
 * Color quantization level analysis
 */
...
export function analyzeColorQuantizationVideo(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        name: "Color Quantization", nameKey: "signal.colorQuantizationVideo", category: "forensic", score, weight: 0.2,
        description: score > 55 ? "Color quantization level analysis — potential AI-generated video artifact" : "Natural color quantization level analysis — consistent with authentic video",
        descriptionKey: score > 55 ? "signal.colorQuantizationVideo.ai" : "signal.colorQuantizationVideo.real", icon: "🎨",
