 ...
 * Spatial frequency temporal stability
 */
...
export function analyzeSpatialFreqTemporal(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Spatial frequency temporal stability — potential AI-generated video artifact" : "Natural spatial frequency temporal stability — consistent with authentic video",
