...
export function analyzeVideoSaturation(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Video saturation distribution — potential AI-generated video artifact" : "Natural video saturation distribution — consistent with authentic video",
