 ...
 * Ear shape and symmetry consistency
 */
...
export function analyzeEarSymmetryAnalysis(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Ear shape and symmetry consistency — potential AI-generated video artifact" : "Natural ear shape and symmetry consistency — consistent with authentic video",
