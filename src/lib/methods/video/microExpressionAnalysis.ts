 ...
 * Micro-expression detection and naturalness
 */
...
export function analyzeMicroExpressionAnalysis(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Micro-expression detection and naturalness — potential AI-generated video artifact" : "Natural micro-expression detection and naturalness — consistent with authentic video",
