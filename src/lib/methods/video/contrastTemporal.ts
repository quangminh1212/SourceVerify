...
export function analyzeContrastTemporal(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    ...
    return {
        ...
        description: score > 55 ? "Contrast temporal stability — potential AI-generated video artifact" : "Natural contrast temporal stability — consistent with authentic video",
