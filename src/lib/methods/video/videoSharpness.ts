/**
 * Video Sharpness
 * Video sharpness consistency
 */
import type { AnalysisMethod } from "../../types";

export function analyzeVideoSharpness(pixels: Uint8ClampedArray, w: number, h: number): AnalysisMethod {
    if (w < 16 || h < 16) {
        return { name: "Video Sharpness", nameKey: "signal.videoSharpness", category: "forensic", score: 50, weight: 0.2, description: "Frame too small", descriptionKey: "signal.videoSharpness.error", icon: "🔪" };
    }
    const blockSize = 8;
    ...
    return {
        ...
        description: score > 55 ? "Video sharpness consistency — potential AI-generated video artifact" : "Natural video sharpness consistency — consistent with authentic video",
