...
export function analyzeConclusionPattern(text: string): AnalysisMethod {
    ...
    if (sentences.length < 3) {
        return { name: "Conclusion Pattern", nameKey: "signal.conclusionPattern", category: "statistical", score: 50, weight: 0.2, description: "Too few sentences", descriptionKey: "signal.conclusionPattern.error", icon: "🏁" };
    }
    ...
    return {
        ...
        description: score > 55 ? "Conclusion structure analysis — pattern suggests AI generation" : "Natural conclusion structure analysis — consistent with human writing",
