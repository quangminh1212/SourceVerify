/**
 * Information Density
 * Information per sentence analysis
 */
...
export function analyzeInformationDensity(text: string): AnalysisMethod {
    ...
    if (sentences.length < 3) {
        return { name: "Information Density", nameKey: "signal.informationDensity", category: "statistical", score: 50, weight: 0.2, description: "Too few sentences", descriptionKey: "signal.informationDensity.error", icon: "📊" };
    }
    ...
    return {
        ...
        description: score > 55 ? "Information per sentence analysis — pattern suggests AI generation" : "Natural information per sentence analysis — consistent with human writing",
