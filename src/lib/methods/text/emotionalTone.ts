...
export function analyzeEmotionalTone(text: string): AnalysisMethod {
    ...
    if (sentences.length < 3) {
        return { name: "Emotional Tone Variance", nameKey: "signal.emotionalTone", category: "statistical", score: 50, weight: 0.2, description: "Too few sentences", descriptionKey: "signal.emotionalTone.error", icon: "😢" };
    }
    ...
    return {
        ...
        description: score > 55 ? "Emotional variation analysis — pattern suggests AI generation" : "Natural emotional variation analysis — consistent with human writing",
