/**
 * Hapax Legomena
 * Unique word occurrence analysis
 */
...
export function analyzeHapaxLegomena(text: string): AnalysisMethod {
    ...
    if (sentences.length < 3) {
        return { name: "Hapax Legomena", nameKey: "signal.hapaxLegomena", category: "statistical", score: 50, weight: 0.2, description: "Too few sentences", descriptionKey: "signal.hapaxLegomena.error", icon: "🆕" };
    }
    ...
    return {
        ...
        description: score > 55 ? "Unique word occurrence analysis — pattern suggests AI generation" : "Natural unique word occurrence analysis — consistent with human writing",
