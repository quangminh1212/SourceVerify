/**
 * Preposition Pattern
 * Preposition distribution analysis
 */
...
export function analyzePrepositionPattern(text: string): AnalysisMethod {
    ...
    if (sentences.length < 3) {
        return { name: "Preposition Pattern", nameKey: "signal.prepositionPattern", category: "statistical", score: 50, weight: 0.2, description: "Too few sentences", descriptionKey: "signal.prepositionPattern.error", icon: "📍" };
    }
    ...
    return {
        ...
        description: score > 55 ? "Preposition distribution analysis — pattern suggests AI generation" : "Natural preposition distribution analysis — consistent with human writing",
