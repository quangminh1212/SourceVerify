...
export const TEXT_METHOD_MAP: Record<string, string> = {
    ...
    // AUTO_FIXED_MISSING_MAPPINGS_1775034876964
    lip_sync_analysis: "signal.lipSyncAnalysis",
    optical_flow_anomaly: "signal.opticalFlowAnomaly",
    motion_blur_consistency: "signal.motionBlurConsistency",
    video_compression_trace: "signal.videoCompressionTrace",
    flicker_analysis: "signal.flickerAnalysis",
    hand_gesture_consistency: "signal.handGestureConsistency",
    speech_cadence: "signal.speechCadence",
    ear_consistency: "signal.earConsistency",
    hair_dynamics: "signal.hairDynamics",
    skin_texture_temporal: "signal.skinTextureTemporal",
    shadow_consistency_video: "signal.shadowConsistencyVideo",
    reflection_consistency_video: "signal.reflectionConsistencyVideo",
    pupil_dynamics: "signal.pupilDynamics",
    head_pose_estimation: "signal.headPoseEstimation",
    video_noise_pattern: "signal.videoNoisePattern",
    heartbeat_detection: "signal.heartbeatDetection",
    clothing_consistency: "signal.clothingConsistency",
    face_3d_reconstruction: "signal.face3dReconstruction",
    video_codec_analysis: "signal.videoCodecAnalysis",
    inter_frame_forgery: "signal.interFrameForgery",
    head_pose_v2: "signal.headPoseV2",
    micro_expression_v2: "signal.microExpressionV2",
    svd_decomposition: "signal.svdDecomposition",
    curvelet_transform: "signal.curveletTransform",
    contourlet_analysis: "signal.contourletAnalysis",
    shearlet_analysis: "signal.shearletAnalysis",
    ssim_map: "signal.ssimMap",
    total_variation: "signal.totalVariation",
    hessian_matrix: "signal.hessianMatrix",
    steerable_pyramid: "signal.steerablePyramid",
    pixel_value_diff: "signal.pixelValueDiff",
    run_length_matrix: "signal.runLengthMatrix",
    convolutional_trace: "signal.convolutionalTrace",
    wavelet_packet: "signal.waveletPacket",
    gabor_phase: "signal.gaborPhase",
    gradient_weighted_cam: "signal.gradientWeightedCam",
    discrete_cosine_energy: "signal.discreteCosineEnergy",
    multiscale_entropy: "signal.multiscaleEntropy",
    gradient_divergence: "signal.gradientDivergence",
    moment_invariants: "signal.momentInvariants",
    niqe_score: "signal.niqeScore",
    harris_corner: "signal.harrisCorner",
    laplacian_pyramid: "signal.laplacianPyramid",
    census_transform: "signal.censusTransform",
    gabor_wavelet_bank: "signal.gaborWaveletBank",
    sparse_representation: "signal.sparseRepresentation",
    log_gabor_filter: "signal.logGaborFilter",
    facs_analysis: "signal.facsAnalysis",
    phoneme_viseme_map: "signal.phonemeVisemeMap",
    saccade_analysis: "signal.saccadeAnalysis",
    pupillary_unrest: "signal.pupillaryUnrest",
    head_nod_shake: "signal.headNodShake",
    identity_switch: "signal.identitySwitch",
    qp_analysis: "signal.qpAnalysis",
    intra_prediction: "signal.intraPrediction",
    motion_estimation_res: "signal.motionEstimationRes",
    bframe_consistency: "signal.bframeConsistency",
    scene_cut_anomaly: "signal.sceneCutAnomaly",
    voice_f0_analysis: "signal.voiceF0Analysis",
    lip_reading_score: "signal.lipReadingScore",
    facial_action_timing: "signal.facialActionTiming",
    video_spectral_coherence: "signal.videoSpectralCoherence",
    micro_tremor: "signal.microTremor",
    skin_specular_reflection: "signal.skinSpecularReflection",
    gaze_vergence: "signal.gazeVergence",
    temporal_face_embedding: "signal.temporalFaceEmbedding",
    audio_formant: "signal.audioFormant",
    video_denoising_trace: "signal.videoDenoisingTrace",
    facial_aging_consistency: "signal.facialAgingConsistency",
    background_object_physics: "signal.backgroundObjectPhysics",
    hand_finger_count: "signal.handFingerCount",
    temporal_frequency_anomaly: "signal.temporalFrequencyAnomaly",
    binoculars_detect: "signal.binocularsDetect",
    fast_detectgpt: "signal.fastDetectgpt",
    ghostbuster_detect: "signal.ghostbusterDetect",
    likelihood_divergence: "signal.likelihoodDivergence",
    semantic_coherence_graph: "signal.semanticCoherenceGraph",
    syntactic_tree_depth: "signal.syntacticTreeDepth",
    pragmatic_adequacy: "signal.pragmaticAdequacy",
    max_softmax_prob: "signal.maxSoftmaxProb",
    rank_probability: "signal.rankProbability",
    dna_gpt_uniqueness: "signal.dnaGptUniqueness",
    phd_detection: "signal.phdDetection",
    radar_detect: "signal.radarDetect",
    cross_entropy_variance: "signal.crossEntropyVariance",
    entity_grounding: "signal.entityGrounding",
    discourse_relation_depth: "signal.discourseRelationDepth",
    coh_metrix_index: "signal.cohMetrixIndex",
    contextual_embedding_var: "signal.contextualEmbeddingVar",
    argument_density: "signal.argumentDensity",
    topic_model_divergence: "signal.topicModelDivergence",
    causal_reasoning: "signal.causalReasoning",
    vocabulary_age: "signal.vocabularyAge",
    text_fingerprint: "signal.textFingerprint",
    local_coherence_model: "signal.localCoherenceModel",
    information_theoretic_profile: "signal.informationTheoreticProfile",
    register_variation: "signal.registerVariation",
};
