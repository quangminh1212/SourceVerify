      ...
      <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-white/60">
        <div className="flex items-center justify-between px-6 sm:px-10 py-4 max-w-5xl mx-auto w-full">
          <div className="flex items-center gap-3">
            ...
            <span className="text-base font-bold tracking-tight gradient-text">SourceVerify</span>
          </div>
          <a href="https://github.com/quangminh1212/SourceVerify" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 text-sm font-medium text-[--color-text-secondary] hover:text-[--color-text-primary] transition-all hover:-translate-y-0.5">
