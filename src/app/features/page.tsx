            ...
            <section className="relative z-10 px-4 sm:px-6 pb-16">
                <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {FEATURES.map((feat, i) => (
                        <div
                            key={feat.title}
                            className={`group relative rounded-2xl bg-transparent p-6 sm:p-7 transition-all duration-300 hover:-translate-y-1 hover:bg-white/40 hover:shadow-[0_8px_40px_rgba(66,133,244,0.08)] animate-fade-in-up animate-delay-${Math.min(i, 5)}`}
                        >
