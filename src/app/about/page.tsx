        ...
        <main className="relative min-h-screen flex flex-col">
            ...
            <div className="flex-1 grid place-items-center px-4 sm:px-6 lg:px-8 py-14 sm:py-16 lg:py-20">
                <div className="w-full max-w-5xl mx-auto text-center">
                    ...
                    <div style={{ marginBottom: '120px' }} className="animate-fade-in-up">
                    ...
                    <div style={{ marginBottom: '120px' }} className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 animate-fade-in-up animate-delay-1">
                        {stats.map((stat) => (
                            <div
                                key={stat.labelKey}
