...
Ngưỡng cuối cùng đặt như sau: điểm $\geq 55$ là \texttt{ai}, $\leq 40$ là \texttt{real}, còn lại là \texttt{uncertain}. Độ tin cậy được tính dựa trên khoảng cách của điểm tới ngưỡng, điểm càng xa vùng giữa thì càng chắc chắn.
