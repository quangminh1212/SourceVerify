...
\section{Sản phẩm}
Hiện tại SourceVerify đã có giao diện kéo-thả ảnh, trang kết quả hiện điểm AI cùng danh sách tín hiệu, và trang tài liệu cho các phương pháp. Hình \ref{fig:homepage-mockup} và Hình \ref{fig:ui-mockup} mô tả giao diện thực tế của hệ thống.

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{resource/image.png}
\caption{Giao diện SourceVerify với khu vực kéo-thả ảnh và kết quả phân tích}
...
\centering
\includegraphics[width=0.9\textwidth]{resource/image.png}
\caption{Giao diện SourceVerify hiển thị kết quả phân tích chi tiết}
\label{fig:ui-mockup}
\end{figure}
