...
Để đo thử hiệu quả, em viết một script benchmark chạy trên tập ảnh nhỏ gồm 120 ảnh thật và 120 ảnh AI, resize tối đa 320px cho dễ lặp lại. Em dùng \textit{strict accuracy} (tỉ lệ đoán đúng, điểm 50 tính là sai vì phương pháp không dám quyết), \textit{classified accuracy} (chỉ tính những ảnh được phân loại) và \textit{coverage} (tỉ lệ ảnh không bị bỏ trung tính).
...
\begin{itemize}
  ...
  \item DCT Block khi dám phân loại thì khá đúng (71.6\%) nhưng hay bỏ trung tính với ảnh PNG hoặc đã resize.
