...
\]
Sau đó em tính ba chỉ số: độ không đều của nhiễu giữa các khối ($CV$), tương quan giữa độ sáng và mức nhiễu ($\rho$), và độ lệch kurtosis so với nhiễu Gauss. Ảnh thật có $CV$ cao (nhiễu chỗ nhiều chỗ ít) và $\rho>0$ (vùng sáng nhiễu nhiều hơn); ảnh AI thì $CV$ thấp và $\rho$ gần 0. Hình \ref{fig:noise-shot} minh họa rõ điều này: các chấm của ảnh thật đi lên theo độ sáng, còn ảnh AI nằm ngang.
